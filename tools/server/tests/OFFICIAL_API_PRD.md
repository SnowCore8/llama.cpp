...
- 状态注：实现与文档登记已落地并提交（`6bf39f10a`/`68776830a`/`137493cd0`）；**复验已于 2026-09-14 完成**（见 §5 #8）：401/503/exceed 运行期探针 17 PASS / 0 FAIL（`/tmp/env-503-aux/`），9B 全量三套件新基线 530 = 506 PASS / 24 SKIP / 0 FAIL（`/tmp/best-of-slots/reports-ttlfix/`）。
